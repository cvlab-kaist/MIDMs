...
def random_crop(img, kps, bbox, size=(512, 512), p=0.5):
    ...
    resized_img = torchvision.transforms.functional.resized_crop(img, top, left, height, width, size=size)
...
class CorrespondenceDataset(Dataset):
    ...
    def __init__(self, benchmark, datapath, thres, device, split, augmentation, feature_size):
        ...
        self.metadata = {
            "pfwillow": ("PF-WILLOW", "test_pairs.csv", "", "", "bbox"),
            "pfpascal": ("PF-PASCAL", "_pairs.csv", "JPEGImages", "Annotations", "img"),
            "caltech": ("Caltech-101", "test_pairs_caltech_with_category.csv", "101_ObjectCategories", "", ""),
        ...
        self.kps_to_flow = KeypointToFlow(
            receptive_field_size=35, jsz=256 // feature_size, feat_size=feature_size, img_size=self.imside
        )
